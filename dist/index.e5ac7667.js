...
setTimeout(diff,3000);*/ //setInterval(diff,3000);
//clr=setInterval(diff,3000);
...
console.log(parsed);*/ let db = document.getElementsByTagName("button");
for(let k = 1; k < 15; k++)db[k].addEventListener("click", function() {
...
let fl = document.getElementsByClassName("gi"); //do the click button show content of flashcards
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dyO8b","aitAD"], "aitAD", "parcelRequire6e9c")
